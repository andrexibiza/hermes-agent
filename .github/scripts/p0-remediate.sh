...
# Cover every Nano ID v3 consumer, not only the PostCSS edge. Keep v6 isolated.
...
# Force npm to refresh still-compatible vulnerable v3 lock entries, then regenerate.
