...
def test_timeout_finalization_is_monotonic_across_500_transitions():
    for _ in range(500):
        ...
        # Simulate completion arriving after timeout finalization, then a stale
        # success finalization. Neither edge may restore trust.
        manager._complete_external_prefetch(lease)
